...
function renderContent(notification: NotificationItemProps) {
  ...
  if (notification.type === 'mail') {
    return {
      avatarUrl: (
        <Image alt={notification.title} src="/assets/icons/notification/ic-notification-mail.svg" width={40} height={40} />
      ),
      title,
    };
  }
  if (notification.type === 'chat-message') {
    return {
      avatarUrl: (
        <Image alt={notification.title} src="/assets/icons/notification/ic-notification-chat.svg" width={40} height={40} />
      ),
      title,
    };
  }
  return {
    avatarUrl: notification.avatarUrl ? (
      <Image alt={notification.title} src={notification.avatarUrl} width={40} height={40} />
    ) : null,
    title,
  };
}
